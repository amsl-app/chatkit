...
impl From<ToolChoice> for async_openai::types::chat::ChatCompletionToolChoiceOption {
...
impl TryFrom<ToolSchema> for async_openai::types::chat::ChatCompletionTools {
    ...
    fn try_from(schema: ToolSchema) -> Result<async_openai::types::chat::ChatCompletionTools, Self::Error> {
        ...
        let function = async_openai::types::chat::FunctionObject {
            name: title.clone(),
        ...
        Ok(async_openai::types::chat::ChatCompletionTools::Function(
...
mod tests {
    ...
    fn test_as_llm_tool() {
        ...
        let llm_tool: async_openai::types::chat::ChatCompletionTools =
            schema.try_into().expect("Failed to convert to LLM tool");
